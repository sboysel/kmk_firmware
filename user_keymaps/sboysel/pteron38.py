...
# NUM (layer 2)
LT_BSPC = KC.LT(2, KC.BSPC, prefer_hold=True, tap_interrupted=False, tap_time=keyboard.tap_time)
# SYM (layer 3)
...
keyboard.keymap = [
    ...
    [
        ...
        KC.NO,   LT_ESC,  LT_SPC,  LT_TAB,  KC.NO,      KC.NO,  LT_ENT,  LT_BSPC, LT_DEL,  KC.NO
    ],                  
    ...
    [
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,      KC.NO,  KC.ENT,  KC.BSPC, KC.DEL,  KC.NO
    ],
    # NUM
    [
        ...
        KC.NO,   KC.DOT,  KC.N0,   KC.MINS, KC.NO,      KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO
    ],
    # SYM
    [
        ...
        KC.NO,   KC.LPRN, KC.RPRN, KC.UNDS, KC.NO,      KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO
    ],
    # FUN
    [
        ...
        KC.NO,   KC.APP,  KC.SPC,  KC.TAB,  KC.NO,      KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO
    ],
    # MEDIA
    [
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,      KC.NO,     KC.NO,   KC.NO,   KC.NO,   KC.NO,
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,      KC.NO,     KC.MSTP, KC.MPLY, KC.MUTE, KC.NO
    ],
]
