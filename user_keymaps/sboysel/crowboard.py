...
# NUM (layer 2)
LT_ENT = KC.LT(2, KC.ENT, prefer_hold=True, tap_interrupted=False, tap_time=200)
# SYM (layer 3)
LT_BSPC = KC.LT(3, KC.BSPC, prefer_hold=True, tap_interrupted=False, tap_time=200)
# FUN (layer 4)
...
# === home row mods ------------------------------------------------------------
MT_A = KC.MT(KC.A, KC.LALT, prefer_hold=False, tap_interrupted=True, tap_time=200)
MT_S = KC.MT(KC.S, KC.LCTL, prefer_hold=False, tap_interrupted=True, tap_time=200)
MT_D = KC.MT(KC.D, KC.LGUI, prefer_hold=False, tap_interrupted=True, tap_time=200)
...
MT_K = KC.MT(KC.K, KC.LGUI, prefer_hold=False, tap_interrupted=True, tap_time=200)
MT_L = KC.MT(KC.L, KC.LCTL, prefer_hold=False, tap_interrupted=True, tap_time=200)
MT_QUOT = KC.MT(KC.QUOT, KC.LALT, prefer_hold=False, tap_interrupted=True, tap_time=200)
...
keyboard.keymap = [
    ...
    [
        ...
        KC.Z,    KC.X,    KC.C,    KC.V,    KC.B,       KC.N,   KC.M,    KC.COMM, KC.DOT,  KC.SLSH,
                          LT_ESC,  KC.SPC,  LT_TAB,     LT_ENT, LT_BSPC, LT_DEL
    ],                  
