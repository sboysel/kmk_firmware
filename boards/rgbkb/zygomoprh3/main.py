...
# NAV (layer 2)
LT_TAB = KC.LT(2, KC.TAB, prefer_hold=True, tap_interrupted=False, tap_time=200)
# SYM (layer 3)
LT_ENT = KC.LT(3, KC.ENT, prefer_hold=True, tap_interrupted=False, tap_time=200)
# NUM (layer 4)
LT_BSPC = KC.LT(4, KC.BSPC, prefer_hold=True, tap_interrupted=False, tap_time=200)
...
keyboard.keymap = [
    [ # BASE
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   LT_SPC, LT_TAB, LT_ENT, LT_BSPC, KC.NO,  KC.NO,   KC.NO,   KC.NO,
    ],                  
    [ # FUN (Space key, Layer 1)
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.ESC, KC.DEL,  KC.NO,   KC.NO,   KC.NO,   KC.NO,
    ],
    [ # NAV (Tab key, Layer 2)
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,  KC.ENT, KC.BSPC, KC.NO,   KC.NO,   KC.NO,   KC.NO
    ],
    [ # SYM (Enter key, Layer 3)
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,
        KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.RPRN, KC.UNDS, KC.NO,  KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,
    ],
    [ # NUM (Backspace key, Layer 4)
        ...
        KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.NO,   KC.NO,   KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,
        KC.NO,   KC.NO,   KC.NO,   KC.NO,  KC.N0,   KC.MINS, KC.NO,  KC.NO,   KC.NO,   KC.NO,   KC.NO,   KC.NO,
    ],
]
